...
module.exports = (function () {
    ...
    var adapter = {
        ...
        registerConnection: function (connection, collections, cb) {
            ...
            if (adapter._connections && adapter._connections._transaction) {
                collections.forEach(function (collection) {
                    collection.transaction = adapter._connections._transaction;
                });
            }
        ...
        connectConnection: function (conn, cb) {
            ...
            if (persistent && !connected) {
                ...
                adapter._connections = connection.mssqlConnection = new Transation(connection.mssqlConnection);
                ...
                adapter._connections = connection.mssqlConnection[uniqId] = new Transation(connection.mssqlConnection[uniqId]);
            } else {
                _.defer(cb);
            }
        },
